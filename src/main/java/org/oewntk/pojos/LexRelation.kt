...
class LexRelation(
    ...
    override fun toString() = "${rel.name2}: $fromSynsetId[$fromWord] -> $toSynsetId[${toWord.wordNum}]"

    fun toString(toWord: String): String = "${rel.name2}: $fromSynsetId[$fromWord] -> $toSynsetId[$toWord]"
}
