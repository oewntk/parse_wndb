 ...
 * @param type     relation name
 * @param recurses whether relation can recurse
 *
 * @author Bernard Bou
 */
enum class RelationQualifier(private val symbol: String, val type: String, val recurses: Boolean) {
    ...
    companion object {
        @JvmField val SYNSET_RELATIONS:Set<String> = setOf( //
        "hypernym", "hyponym",  //
        ...
        @JvmField val SENSE_RELATIONS:Set<String> = setOf( //
        "antonym",  //
        "similar",  //
        "exemplifies", "is_exemplified_by",  //
        "derivation",  //
        ...
        "other")
         ...
         // @formatter:on
         private val MAP: MutableMap<String, RelationQualifier> = HashMap()
	    ...
	    fun parseRelationType(str: String): RelationQualifier {
